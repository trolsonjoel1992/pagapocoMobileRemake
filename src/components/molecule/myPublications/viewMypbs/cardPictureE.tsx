...
import { useCardPictureE } from '@/src/hooks/mypublication/useCardPictureE';
import React from 'react';
import { FlatList, Text, View } from 'react-native';
import { moderateScale } from 'react-native-size-matters';

type CardPictureEProps = {
  images: string[];
  setImages: React.Dispatch<React.SetStateAction<string[]>>;
};

const CardPictureE = ({ images, setImages }: CardPictureEProps) => {
  const {
    colors,
    theme,
    attempts,
    ...
    getSubtitleText,
    handleDisabledPress,
  } = useCardPictureE(images, setImages);
