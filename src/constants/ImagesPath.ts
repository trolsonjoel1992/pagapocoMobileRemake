const ImagesPath = {
  ...
  imageAutoFiatToro: require('@/src/assets/images/ImagePublication/autos/imageAutoFiatToro.jpg'),
  imageAutoJeepRenegade: require('@/src/assets/images/ImagePublication/autos/imageAutoJeppRenegade.jpg'),
  ...
  // nuevos iconos agregados para notificaciones
  iconEye: require('@/src/assets/images/publicationsbuton/eyenotif.png'),
  iconTrash: require('@/src/assets/images/publicationsbuton/basurero.png'),
  ...
  // imagenes seleccion para editar publics
