...
const Publication3 = () => {
  ...
  const carouselImages = [
    { id: '1', image: ImagesPath.imageCamionScania },
    { id: '2', image: ImagesPath.imageCamionScania },
    { id: '3', image: ImagesPath.imageCamionScania },
  ]

  // actualiza el indice de la imagen visible
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.publicationContainer}>
          <Text style={styles.publicationInfo}>
            1987 | 150.000 km - Publicado hace 2 semanas
          </Text>
          <Text style={styles.publicationTitle}>Scania 112</Text>
          ...
          <View style={styles.labelPublicationContainer}>
            <Text style={styles.priceText}>$ 57.500.000</Text>
            <Text
              style={styles.descriptionTitle}
              numberOfLines={expanded ? undefined : 3}
              ellipsizeMode="tail"
            >
              vendo modelo 87 muy lindo permuto menor valor de mi interes precio publicado corrientes capital se escucha oferta contado
            </Text>
            <TouchableOpacity
